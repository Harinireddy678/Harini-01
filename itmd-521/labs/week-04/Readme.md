...
Add the required screenshots here:!![sbt ](<sbt file -h.png>)

### Screenshot of the printSchema inferred in Python

Screenshot goes here!![py code](<py code -h.png>)

### Screenshot of the printSchema programmatically in Python

Screenshot goes here!![py schema](<py schema -h.png>)

### Screenshot of the printSchema via DDL in Python

Screenshot goes here!![python](<py run -h.png>)

### Screenshot of the printSchema inferred in Scala

Screenshot goes here!![scala code](<scala code -h.png>)

### Screenshot of the printSchema programmatically in Scala

Screenshot goes here!![scala schema](<scala schema -h.png>)

### Screenshot of the printSchema via DDL in Scala

Screenshot goes here!![scala run](<scala run-h.png>)
